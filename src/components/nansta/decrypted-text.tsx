...
export default function DecryptedText({
  ...
  const animateProps =
    animateOn === 'hover' || animateOn === 'inViewHover'
      ? { onMouseEnter: () => { if (!isAnimating) { setRevealedIndices(new Set()); setIsDecrypted(false); setDisplayText(text); setDirection('forward'); setIsAnimating(true); } }, onMouseLeave: () => { setIsAnimating(false); setRevealedIndices(new Set()); setDisplayText(text); setIsDecrypted(true); setDirection('forward'); } }
      : animateOn === 'click'
        ? { onClick: () => { if (clickMode === 'once' && isDecrypted) return; setDirection('forward'); triggerDecrypt(); } }
        : {};
